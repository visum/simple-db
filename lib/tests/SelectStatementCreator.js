...
exports["SelectStatementCreator: isNotEqualTo."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").isNotEqualTo("value");
    var selectStatementCreator = new _SelectStatementCreator2.default(queryable);
...
exports["SelectStatementCreator: contains."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").contains("value");
    var selectStatementCreator = new _SelectStatementCreator2.default(queryable);
...
exports["SelectStatementCreator: startsWith."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").startsWith("value");
    var selectStatementCreator = new _SelectStatementCreator2.default(queryable);
...
exports["SelectStatementCreator: endsWith."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").endsWith("value");
    var selectStatementCreator = new _SelectStatementCreator2.default(queryable);
...
exports["SelectStatementCreator: isGreaterThan."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").isGreaterThan(0);
    var selectStatementCreator = new _SelectStatementCreator2.default(queryable);
...
exports["SelectStatementCreator: isGreaterThanOrEqualTo."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").isGreaterThanOrEqualTo(0);
    var selectStatementCreator = new _SelectStatementCreator2.default(queryable);
...
exports["SelectStatementCreator: isLessThan."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").isLessThan(0);
    var selectStatementCreator = new _SelectStatementCreator2.default(queryable);
...
exports["SelectStatementCreator: isLessThanOrEqualTo."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").isLessThanOrEqualTo(0);
    var selectStatementCreator = new _SelectStatementCreator2.default(queryable);
...
exports["SelectStatementCreator: isIn with array."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").isIn(["John", "Jane"]);
    var selectStatementCreator = new _SelectStatementCreator2.default(queryable);
...
exports["SelectStatementCreator: isNotIn with array."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").isNotIn(["John", "Jane"]);
    var selectStatementCreator = new _SelectStatementCreator2.default(queryable);
...
exports["SelectStatementCreator: isIn with queryable."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "other_table" } }).select({ id: "id" });
    var rootQueryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").isIn(queryable);
...
exports["SelectStatementCreator: isNotIn with queryable."] = function () {
    var queryable = new _Queryable2.default({ query: { type: "other_table" } }).select({ id: "id" });
    var rootQueryable = new _Queryable2.default({ query: { type: "table" } }).column("columnName").isNotIn(queryable);
    var selectStatementCreator = new _SelectStatementCreator2.default(rootQueryable);
