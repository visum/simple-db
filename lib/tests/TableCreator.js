...
exports["TableCreator: createTableIfNotExistsAsync."] = function () {
...
exports["TableCreator: createTableIfNotExistsAsync twice."] = function () {
    var database = new _sqlite2.default.Database(":memory:");
    var tableCreator = new _TableCreator2.default({
        schema: testSchema,
        database: database
    ...
    return tableCreator.createTableIfNotExistsAsync().then(function () {
        return tableCreator.createTableIfNotExistsAsync();
    });
};

exports["TableCreator: createTableIfNotExistsAsync then Drop"] = function () {
    var database = new _sqlite2.default.Database(":memory:");
    var tableCreator = new _TableCreator2.default({
        schema: testSchema,
        database: database
