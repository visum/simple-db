...
exports["Queryable: toArrayAsync."] = function () {
    ...
    return createDatabasePromise.then(function () {
        ...
        return table.where().column("firstName").endsWith("ohn1").orderByDesc("id").toArrayAsync();
...
exports["Queryable: IsIn with Array."] = function () {
    ...
    return createDatabasePromise.then(function () {
        ...
        return table.where().column("firstName").isIn(["John1"]).toArrayAsync();
    }).then(function (results) {
        assert.equal(results.length, 1);
        database.close();
    }).catch(function (error) {
...
exports["Queryable: getFirstAsync"] = function () {
    ...
    return createDatabasePromise.then(function () {
        ...
        return table.where().column("firstName").endsWith("1").getFirstAsync();
...
exports["Queryable: updateAsync"] = function () {
    ...
    return createDatabasePromise.then(function () {
        ...
        return table.where().column("firstName").endsWith("John1").updateAsync({
            firstName: "Jane"
        });
    }).then(function () {
