...
exports["Table: canEntityBeAddedAsync"] = function () {
    ...
    var table = new _Table2.default({
        ...
        schema: _person2.default,
        lifeCycleDelegate: {
            canEntityBeAddedAsync: function canEntityBeAddedAsync(entity) {
                called = true;
                return true;
            }
        }
...
exports["Table: entityAddedAsync"] = function () {
    ...
    var table = new _Table2.default({
        ...
        schema: _person2.default,
        lifeCycleDelegate: {
            entityAddedAsync: function entityAddedAsync(entity) {
                called = true;
...
exports["Table: refineQueryable"] = function () {
    ...
    var table = new _Table2.default({
        ...
        schema: _person2.default,
        lifeCycleDelegate: {
            refineQueryable: function refineQueryable(queryable) {
