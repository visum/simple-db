...
var _OperationBuilder = _interopRequireDefault(require("./OperationBuilder"));

var _CompositeNode = _interopRequireDefault(require("../../lib/queryable/abstractSyntaxTree/CompositeNode"));
...
class Queryable {
  ...
  column(column) {
    ...
    const builder = new _OperationBuilder.default(this, column);
    return builder;
  }
  ...
  static fromObject(query) {
    query.expression = _CompositeNode.default.fromObject(query.expression);
    const queryable = new Queryable({
      provider: this.provider,
      query: query
    });
