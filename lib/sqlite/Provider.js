...
var defaultRefineQueryable = function defaultRefineQueryable(queryable) {
    return queryable;
};
...
var Provider = function () {
    function Provider(_ref) {
        var database = _ref.database,
            refineQueryable = _ref.refineQueryable;
    ...
    _createClass(Provider, [{
        key: "_safelyRefineQueryable",
        value: function _safelyRefineQueryable(queryable) {
            try {
        ...
        value: function getSqlAndValues(queryable) {
            ...
            return _SelectStatementCreator2.default.createStatement(queryable);
        }
    }, {
        key: "removeAsync",
