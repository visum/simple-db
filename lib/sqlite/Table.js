...
class Table {
  ...
  async removeAsync(entity) {
    ...
    const result = await this.sqliteDatabaseWrapper.runAsync(sql, values);
    return (0, _invokeMethodAsync.default)(this.lifeCycleDelegate, "entityRemovedAsync", [entity, result], result);
  }
  ...
  async updateAsync(entity) {
    ...
    const result = await this.sqliteDatabaseWrapper.runAsync(sql, values);
    return await (0, _invokeMethodAsync.default)(this.lifeCycleDelegate, "entityUpdatedAsync", [entity, result], result);
  }
