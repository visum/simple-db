...
var _SchemaToSqliteFactory = require("./factories/SchemaToSqliteFactory");
...
var SqliteDatabaseCreator = function () {
    function SqliteDatabaseCreator(_ref) {
        var database = _ref.database,
            schema = _ref.schema;

        _classCallCheck(this, SqliteDatabaseCreator);

        this.database = database;
        this.schema = schema;
        this.sqliteDatabaseWrapper = new _Sqlite3Wrapper2.default(database);
        this.schemaToSqliteFactory = new _SchemaToSqliteFactory2.default(schema);
    }

    _createClass(SqliteDatabaseCreator, [{
...
exports.default = SqliteDatabaseCreator;
//# sourceMappingURL=SqliteDatabaseCreator.js.map