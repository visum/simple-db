...
class TableStatementCreator {
  ...
  getTableName() {
    return _SqliteUtils.default.escapeName(_SchemaUtils.default.getTableNameFromSchema(this.schema));
  }
  ...
  createForeignKeysExpression() {
    ...
    return Object.keys(foreignKeys).map(name => {
      ...
      const source = _SqliteUtils.default.escapeName(_SchemaUtils.default.getTableNameFromSchema(column.source));
